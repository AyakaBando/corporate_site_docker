...
require_once( '../../inc/lib/DB/.systemEnProductNewsDB.class.php' );

define( 'SQL_TABLE_NAME',    'en_product_news' );
define( 'PAGE_TITLE',        '英語サイト：製品お知らせ' );
define( 'FILE_CATEGORY',     'product_news' );
...
if( $_GET['mode'] == 'del' )
{
    $delet = $query->DataDelete( SQL_TABLE_NAME, $_GET, array( 'title' => 'title', 'id' => 'newsId' ) );
...
$smarty->assign( 'productNewsContentsCategory', $productNewsContentsCategory );
$smarty->assign( 'productNewsType',             $productNewsType );
