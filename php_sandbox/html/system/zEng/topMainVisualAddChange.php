...
define( 'SQL_TABLE_NAME',   'en_topMainVisual' );
define( 'PAGE_TITLE',       '英語サイト：TOPメインビジュアル' );
define( 'FILE_CATEGORY',    'topMainVisual' );
...
$data      = $query->FileList( $_GET['id'] );

if( !$_POST )unset( $_SESSION[FILE_CATEGORY] );

$maxWidth    = array( 1 => 985 );
$maxHeight   = array( 1 => 697 );
$maxImageCnt = 1;
