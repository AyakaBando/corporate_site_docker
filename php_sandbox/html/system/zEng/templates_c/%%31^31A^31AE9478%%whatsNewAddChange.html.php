<?php /* Smarty version 2.6.19, created on 2015-08-18 14:07:25
         compiled from whatsNewAddChange.html */ ?>
...
>
       <div class="patternPan"><?php echo @PAGE_TITLE; ?>
...
<?php endif; ?>
        ...
        <tbody id="group3" style="display:<?php if ($_POST['contentsCategory'] == 3 || ( ! $_POST['contentsCategory'] && $this->_tpl_vars['data']['contentsCategory'] == 3 )): ?>table-row-group<?php else: ?>none<?php endif; ?>">
          <tr>
