...
function openNewMap2(url, name, w, h) {
	var newWin;
	var options = ",toolbar=no,menubar=yes,status=yes,scrollbars=yes,resizable=yes";
	newWin = window.open(url, name,"width=" + w + ",height=" + h + options);
	newWin.focus();
}
function openNewShop2(url, name, w, h) {
	var newWin;
	var options = ",toolbar=yes,menubar=yes,status=yes,scrollbars=yes,resizable=yes,location=yes";
	newWin = window.open(url, name,"width=" + w + ",height=" + h + options);
	newWin.focus();
}