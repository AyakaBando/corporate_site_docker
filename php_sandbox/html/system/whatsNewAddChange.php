...
require_once( '../inc/lib/DB/.systemWhatsNewDB.class.php' );
require_once( './systemConsts.php' );

define( 'SQL_TABLE_NAME',    'whatsNew' );
define( 'PAGE_TITLE',        'ニュース' );
define( 'FILE_CATEGORY',     'whatsNew' );
define( 'IMG_FILE_CATEGORY', 'whatsNew' );
...
foreach( (array)$whatsNewCategory AS $key => $value )
    $categoryGroup[] = $form->createElement( 'radio', null, null, $value, $key, array() );
$form->addGroup( $categoryGroup, 'category', 'コンテンツカテゴリ', array( "&nbsp;&nbsp;&nbsp;\n" ) );
...
$form->addRule( 'category',          'カテゴリを選択してください',            'required', null );
