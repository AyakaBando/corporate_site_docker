<?php /* Smarty version 2.6.19, created on 2023-12-27 11:47:47
         compiled from product_drawingAddChange.html */ ?>
...
<table cellpadding="0" cellspacing="0" style="margin:10px 0;width:340px;">
  <tr class="caption"><th colspan="4" class="center"<?php if ($_POST['imgId']): ?> style="background-color:#ff6500;color:#ffffff;"<?php endif; ?>>
      ファイル<?php if ($_POST['imgId']): ?>修正<?php else: ?>新規登録<?php endif; ?></th></tr>
  <tr>
...
" target="_blank"><img src="./cmn_img/icons/pdf.png" width="70" /></a>
                </p>
    <?php endif; ?>
      <form enctype="multipart/form-data" action="./<?php echo @THE_FILE_NAME; ?>
.php?id=<?php echo $_REQUEST['id']; ?>
" method="post">
          <p class="center" style="margin-bottom:4px;"><input type="file" name="1" /></p>

          <p class="center" style="margin-bottom:12px;">タイトル(ファイル名) : <input type="text" name="imageAlt" value="<?php echo $this->_tpl_vars['upDateImg']['imageAlt']; ?>
" style="width:220px;padding-bottom:4px;" maxlength="10" /></p>
          <p class="center" style="margin-bottom:12px;">DLファイル名(URLリンク) : <input type="text" name="dwFileName" value="<?php echo $this->_tpl_vars['upDateImg']['dwFileName']; ?>
" style="width:220px;padding-bottom:4px;" /></p>
          <p class="center" style="margin-bottom:12px;">エンドポイントURL : <input type="text" name="endPoint" value="<?php echo $this->_tpl_vars['upDateImg']['endPoint']; ?>
" style="width:220px;padding-bottom:4px;" /></p>
          <p class="center" style="margin-bottom:12px;">セールスフォース切り替え設定:<input name="changeFlg" type="checkbox" value="1" id="qf_a82af1" <?php if ($this->_tpl_vars['upDateImg']['changeFlg']): ?>CHECKED<?php endif; ?>><label for="qf_a82af1"> 切り替える</label></p>
...
" />
          <?php if ($_POST['imgId']): ?><input type="hidden" name="imgId" value="<?php echo $this->_tpl_vars['upDateImg']['imgId']; ?>
" /><?php endif; ?>
      </form>
    </td>
  </tr>
...
<tr class="caption">
  <th colspan="4" class="center">登録ファイル一覧</th>
</tr>
<tr>
...
<!--- id=<?php echo $this->_tpl_vars['value']['imgId']; ?>
 ...
 --->
                <?php if ($this->_tpl_vars['value']['fileName']): ?>
                    <p style="text-align:center;height:20px;border:none;">
        <a href="../upImage/<?php echo @FILE_CATEGORY; ?>
/<?php echo $this->_tpl_vars['value']['fileName']; ?>
" target="_blank">ファイルを確認</a>
                                        </p>
                <?php endif; ?>

                <p class="center" style="padding:0 0 6px 0;overflow:hidden;"><?php if ($this->_tpl_vars['value']['imageAlt']): ?>タイトル(ファイル名): <?php echo $this->_tpl_vars['value']['imageAlt']; ?>
<?php endif; ?></p>
                <p class="center" style="padding:0 0 6px 0;overflow:hidden;"><?php if ($this->_tpl_vars['value']['dwFileName']): ?>DLファイル名(URLリンク) : <?php echo $this->_tpl_vars['value']['dwFileName']; ?>
<?php endif; ?></p>
                <p class="center" style="padding:0 0 6px 0;overflow:hidden;"><?php if ($this->_tpl_vars['value']['endPoint']): ?>エンドポイントURL : <?php echo $this->_tpl_vars['value']['endPoint']; ?>
<?php endif; ?></p>
                <p class="center" style="padding:0 0 6px 0;overflow:hidden;"><?php if ($this->_tpl_vars['value']['changeFlg']): ?>切り替え設定: ON<?php endif; ?></p>
