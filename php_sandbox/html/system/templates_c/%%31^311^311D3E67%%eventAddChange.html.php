<?php /* Smarty version 2.6.19, created on 2014-03-28 15:46:49
         compiled from eventAddChange.html */ ?>
...
function clearForm()
{
    document.item.ticketStartDate.value = \'\';
    document.item.ticketMaitStartDate.value = \'\';
}
...
<br />
       ...
       <table cellpadding="0" cellspacing="0" style="margin-bottom:20px;width:100%;">
         <tr class="caption"><th colspan="2" class="center" class="threg">概要</th></tr>
          <tr>
            <th width="18%" style="text-align:right;" class="threg">カテゴリ</th>
          ...
          <tr>
            <th width="16%" style="text-align:right;" class="threg">開催日</th>
            <td class="tdreg"><?php echo $this->_tpl_vars['form']['holdingDate']['html']; ?>
</td>
          </tr>
          <tr>
            <th width="16%" style="text-align:right;" class="threg">開催日（表示用）<span style="color:#ff0000;">＊</span></th>
            <td class="tdreg"><?php echo $this->_tpl_vars['form']['dispHoldingDate']['html']; ?>
</td>
          </tr>
          <tr>
            <th width="16%" style="text-align:right;" class="threg">開場時間</th>
            <td class="tdreg"><?php echo $this->_tpl_vars['form']['openHall']['html']; ?>
</td>
          </tr>
          <tr>
            <th width="16%" style="text-align:right;" class="threg">開演時間</th>
            <td class="tdreg"><?php echo $this->_tpl_vars['form']['openTime']['html']; ?>
</td>
          </tr>
          <tr>
            <th width="16%" style="text-align:right;" class="threg">会場</th>
            <td class="tdreg"><?php echo $this->_tpl_vars['form']['eventHall']['html']; ?>
</td>
          </tr>
          <tr>
            <th width="16%" style="text-align:right;" class="threg">座席表リンク</th>
            <td class="tdreg"><?php echo $this->_tpl_vars['form']['zasekiFlg']['html']; ?>
</td>
          </tr>
          <tr>
            <th width="16%" style="text-align:right;" class="threg">種別</th>
            <td class="tdreg"><?php echo $this->_tpl_vars['form']['eventKind']['html']; ?>
</td>
          </tr>
          <tr>
...
<br />
          ...
          <tr>
            ...
            <td class="tdreg">
              タイトル：<?php echo $this->_tpl_vars['form']['urlTitle']['html']; ?>
<br />
              アドレス：<?php echo $this->_tpl_vars['form']['url']['html']; ?>
...
" />
          ...
          <tr>
            ...
            <td class="tdreg">公益財団法人尼崎市総合文化センター/<?php echo $this->_tpl_vars['form']['sponsorship']['html']; ?>
</td>
          </tr>
          <tr>
            <th width="16%" style="text-align:right;" class="threg">後援</th>
...
<!--▲改行しない▲-->
          ...
          <tr>
            <th width="16%" style="text-align:right;" class="threg">注目のイベント</th>
            <td class="tdreg">
            <p style="float:left;display:inline;"><?php echo $this->_tpl_vars['form']['keisaiFlg']['html']; ?>
</p>
<?php unset($this->_sections['cnt']);
$this->_sections['cnt']['name'] = 'cnt';
$this->_sections['cnt']['start'] = (int)1;
