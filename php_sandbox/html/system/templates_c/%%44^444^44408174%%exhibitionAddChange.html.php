<?php /* Smarty version 2.6.19, created on 2014-03-26 17:34:52
         compiled from exhibitionAddChange.html */ ?>
...
function clearForm()
{
    document.item.startDate.value = \'\';
    document.item.endDate.value = \'\';
}
...
<br />
       ...
       <table cellpadding="0" cellspacing="0" style="margin-bottom:20px;width:100%;">
         <tr class="caption"><th colspan="2" class="center" class="threg">概要</th></tr>
          <tr>
            <th width="18%" style="text-align:right;" class="threg">開催期間<span style="color:#ff0000;">＊</span></th>
...
<?php endfor; endif; ?>
          ...
          <tr>
            <th width="16%" style="text-align:right;" class="threg">キャプション</th>
...
" />
          ...
          <tr>
            <th width="16%" style="text-align:right;" class="threg">次回予告</th>
            <td class="tdreg"><?php echo $this->_tpl_vars['form']['nextContents']['html']; ?>
</td>
          </tr>
          <tr>
