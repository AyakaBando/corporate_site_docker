<?php /* Smarty version 2.6.19, created on 2015-07-31 11:48:59
         compiled from product_faqCategoryAddChange.html */ ?>
...
』</b>のFAQカテゴリを<?php if ($_REQUEST['categoryId']): ?>編集<?php else: ?>登録<?php endif; ?>します。<br />
...
" style="padding:6px 16px;line-height:1.8em;display:inline-brock;width:70px;height:24px;text-align:center;background-color:#eeeeee;border:1px solid #999999;">新規登録</a></p>
        <?php endif; ?>
