<?php /* Smarty version 2.6.19, created on 2015-06-01 17:44:36
         compiled from keyWordAddChange.html */ ?>
...
<br />
       ...
       <table cellpadding="0" cellspacing="0" style="margin:0 0 10px 0;width:100%;">
          ...
          <tr>
            <th width="16%" style="text-align:right;" class="threg">キーワード<span style="color:#ff0000;">＊</span></th>
...
?>
<tr>
<td class="tdreg sortThis" data-idnum="<?php echo $this->_tpl_vars['value']['id']; ?>
"></td>
<td class="tdreg" style="width:28px;text-align:right;"><?php echo $this->_tpl_vars['value']['id']; ?>
</td>
