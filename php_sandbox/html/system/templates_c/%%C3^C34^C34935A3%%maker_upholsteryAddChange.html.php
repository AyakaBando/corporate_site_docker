<?php /* Smarty version 2.6.19, created on 2015-06-03 17:50:50
         compiled from maker_upholsteryAddChange.html */ ?>
...
<br />
       ...
       <table cellpadding="0" cellspacing="0" style="margin-bottom:20px;width:100%;">
         <tr class="caption"><th colspan="2" class="center" class="threg">概要</th></tr>
          ...
          <tr>
            <th width="16%" style="text-align:right;" class="threg">ランク<span style="color:#ff0000;">＊</span></th>
            <td class="tdreg"><?php echo $this->_tpl_vars['form']['rank']['html']; ?>
</td>
          </tr>
          <tr>
