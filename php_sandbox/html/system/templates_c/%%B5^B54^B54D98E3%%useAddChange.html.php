<?php /* Smarty version 2.6.19, created on 2015-01-26 11:27:40
         compiled from useAddChange.html */ ?>
...
<div style="width:90%;">
       ...
       <?php echo @PAGE_TITLE; ?>
を<?php if ($_REQUEST['useId']): ?>編集<?php else: ?>登録<?php endif; ?>します。<br />
...
<br />
       ...
       <table cellpadding="0" cellspacing="0" style="margin:0 0 10px 0;width:100%;">
          ...
          <tr>
            <th width="16%" style="text-align:right;" class="threg">用途名<span style="color:#ff0000;">＊</span></th>
            <td class="tdreg"><?php echo $this->_tpl_vars['form']['name']['html']; ?>
</td>
          </tr>
          <tr>
            <th width="16%" style="text-align:right;" class="threg">部位<span style="color:#ff0000;">＊</span></th>
            <td class="tdreg checkBox"><?php if ($this->_tpl_vars['form']['part']['html']): ?><p style="width:33%"><?php echo $this->_tpl_vars['form']['part']['html']; ?>
</p><?php else: ?><span style="color:#ff0000;">部位が登録されていません。</span><?php endif; ?></td>
          </tr>
...
?>
<tr>
<td class="tdreg sortThis" data-idnum="<?php echo $this->_tpl_vars['value']['useId']; ?>
"></td>
<td class="tdreg" style="padding:0 0 0 10px;">
    <a href="./<?php echo @THE_FILE_NAME; ?>
.php?useId=<?php echo $this->_tpl_vars['value']['useId']; ?>
...
" method="post" style="display:inline;">
    ...
    <input type="hidden" value="<?php echo $this->_tpl_vars['value']['useId']; ?>
" name="useId" />
