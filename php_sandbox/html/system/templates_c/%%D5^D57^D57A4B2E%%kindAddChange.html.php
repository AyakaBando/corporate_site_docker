<?php /* Smarty version 2.6.19, created on 2014-12-26 11:19:26
         compiled from kindAddChange.html */ ?>
...
<br />
       ...
       <table cellpadding="0" cellspacing="0" style="margin:0 0 10px 0;width:100%;">
          ...
          <tr>
            <th width="16%" style="text-align:right;" class="threg">品種名<span style="color:#ff0000;">＊</span></th>
            <td class="tdreg"><?php echo $this->_tpl_vars['form']['name']['html']; ?>
</td>
          </tr>
          <tr>
            <th width="16%" style="text-align:right;" class="threg">リンク</th>
            <td class="tdreg"><?php echo $this->_tpl_vars['form']['link']['html']; ?>
</td>
          </tr>
...
<table class="datasheet" cellpadding="0" cellspacing="0" style="margin:10px 0 0 0;width:100%;">
<tr>
...
.php?kindId=<?php echo $this->_tpl_vars['value']['kindId']; ?>
...
" method="post" style="display:inline;">
    ...
    <input type="hidden" value="<?php echo $this->_tpl_vars['value']['kindId']; ?>
" name="kindId" />
