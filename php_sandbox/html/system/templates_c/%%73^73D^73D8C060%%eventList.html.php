<?php /* Smarty version 2.6.19, created on 2014-03-28 16:12:46
         compiled from eventList.html */ ?>
...
>
         <tr>
          <th width="16%" class="threg">タイトル</th>
          <td class="tdreg" style="line-height:2em;"><?php echo $this->_tpl_vars['form']['title']['html']; ?>
</td>
         </tr>
         <tr>
          <th class="threg">イベント種別</th>
          <td class="tdreg"><?php echo $this->_tpl_vars['form']['category']['html']; ?>
</td>
         </tr>
         <tr>
          <th class="threg">トップページ掲載</th>
          <td class="tdreg"><?php echo $this->_tpl_vars['form']['keisaiFlg']['html']; ?>
</td>
         </tr>
         <tr>
          <th class="threg">開催日</th>
          <td class="tdreg">
          <p><?php echo $this->_tpl_vars['form']['dateStart']['Y']['html']; ?>
 年 <?php echo $this->_tpl_vars['form']['dateStart']['m']['html']; ?>
 月 <?php echo $this->_tpl_vars['form']['dateStart']['d']['html']; ?>
 日～
          <?php echo $this->_tpl_vars['form']['dateEnd']['Y']['html']; ?>
 年 <?php echo $this->_tpl_vars['form']['dateEnd']['m']['html']; ?>
 月 <?php echo $this->_tpl_vars['form']['dateEnd']['d']['html']; ?>
 日</p>
          </td>
         </tr>
         <tr>
...
<col width="40px" />
<tr>
<th style="text-align:center;" class="threg">コピー</th>
<th style="text-align:center;" class="threg">種類</th>
<th style="text-align:center;" class="threg">開催日程</th>
<th style="text-align:center;" class="threg">イベントタイトル</th>
...
?>
<tr>
<td style="text-align:center;" class="tdreg"><a href="./<?php echo @THE_FILE_NAME; ?>
.php<?php echo $this->_tpl_vars['getLink']['all']; ?>
<?php if ($this->_tpl_vars['getLink']['all']): ?>&<?php else: ?>?<?php endif; ?>cp=1&id=<?php echo $this->_tpl_vars['value']['id']; ?>
" onclick="cpChk( '<?php echo $this->_tpl_vars['value']['title']; ?>
' )"><img src="./cmn_img/copy.png" alt="コピー" title="コピー" /></a></td>
<td class="tdreg"><?php echo $this->_tpl_vars['artHallCategoryArray'][$this->_tpl_vars['value']['category']]; ?>
</td>
<td class="tdreg"><?php echo $this->_tpl_vars['value']['startDate']; ?>
～<?php echo $this->_tpl_vars['value']['endDate']; ?>
</td>
