<?php /* Smarty version 2.6.19, created on 2015-11-04 19:18:55
...
unset($_smarty_tpl_vars);
 ?>
       ...
       <div style="margin:12px 0 20px 0;padding:10px;border:1px solid <?php if ($_GET['r']): ?>#ff99ff<?php else: ?>#cccccc<?php endif; ?>;background-color:#ffffff;<?php if ($_GET['r']): ?>color:#ff33ff<?php endif; ?>">
         <?php if ($_GET['r'] == 1): ?>
             『<?php echo $this->_tpl_vars['middleCategory'][$_GET['bicCategoryId']][$_GET['category']]; ?>
』の表示順位を変更しました。
         <?php else: ?>
             <?php echo @PAGE_TITLE; ?>
のカテゴリごとに表示順位を変更します。
...
>
       <div style="margin:12px 0 20px 0;padding:10px;border:1px solid #cccccc;background-color:#ffffff;">
       カテゴリを選択してください。<br />
         <?php echo $this->_tpl_vars['form']['bicCategoryId']['html']; ?>
　
...
<table border="0" cellpadding="0" cellspacing="0" class="sortList" style="margin-left:0;background-color:#fff">
  <tr>
    <td style="border:none;">
            <ul id="boxes">
<?php if ($_GET['bicCategoryId'] && $_GET['category']): ?>
...
<?php if ($this->_tpl_vars['data'] && $_GET['bicCategoryId']): ?>
