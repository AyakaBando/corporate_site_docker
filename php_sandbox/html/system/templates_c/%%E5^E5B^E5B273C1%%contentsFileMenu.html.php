<?php /* Smarty version 2.6.19, created on 2019-05-07 14:58:09
...
">登録</a></li>
        ...
        <li class="own<?php if (@PAGE_NUM == 5): ?> active<?php endif; ?>"><?php if (@PAGE_NUM == 5): ?><font><?php else: ?><a href="javascript:void(0)"><?php endif; ?>ニュース&リリース<?php if (@PAGE_NUM == 5): ?></font><?php else: ?></a><?php endif; ?>
            <ul class="child">
