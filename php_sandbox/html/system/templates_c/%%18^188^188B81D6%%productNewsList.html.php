<?php /* Smarty version 2.6.19, created on 2015-07-21 12:00:19
         compiled from productNewsList.html */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'date_format', 'productNewsList.html', 89, false),)), $this); ?>
...
">
    ...
    <th style="width:80px;text-align:center;" class="threg">
        <a href="./<?php echo @THE_FILE_NAME; ?>
.php?sort=contentsCategory&cond=<?php if ($_GET['sort'] == 'contentsCategory' && $_GET['cond'] == 'DESC'): ?>ASC<?php else: ?>DESC<?php endif; ?><?php echo $this->_tpl_vars['sortLink']['addition']; ?>
">
        タイプ
        <img src="cmn_img/<?php if ($_GET['sort'] == 'contentsCategory' && $_GET['cond'] == 'DESC'): ?>down<?php else: ?>up<?php endif; ?>.gif"/></a>
    </th>
...
">
        タイトル
        <img src="cmn_img/<?php if ($_GET['sort'] == 'title' && $_GET['cond'] == 'DESC'): ?>down<?php else: ?>up<?php endif; ?>.gif"/></a>
    </th>
...
&mode=disp&disp=<?php if (! $this->_tpl_vars['value']['dispFlg']): ?>1<?php else: ?>0<?php endif; ?><?php echo $this->_tpl_vars['getLink']['addition']; ?>
">
        <?php if (! $this->_tpl_vars['value']['dispFlg']): ?>非表示<?php else: ?>表示中<?php endif; ?>
            </a>
</td>
<td style="width:13px;text-align:center;" class="tdreg">
    <a href="./<?php echo @THE_FILE_NAME; ?>
