<?php /* Smarty version 2.6.19, created on 2015-06-03 19:58:35
         compiled from maker_architraveTypeList.html */ ?>
...
一覧を表示しています。
       ...
       <?php elseif ($_GET['d'] == 3): ?><b><?php echo $this->_tpl_vars['title']; ?>
</b>をコピーしました。
       <?php elseif ($_GET['d'] == 4): ?>選択した<?php echo @PAGE_TITLE; ?>
を<b><?php if ($_GET['t'] == 1): ?>表示<?php elseif ($_GET['t'] == 2): ?>非表示に<?php elseif ($_GET['t'] == 3): ?>削除<?php endif; ?></b>しました。
       <?php endif; ?>
       </div>
<div class="clear"></div>
