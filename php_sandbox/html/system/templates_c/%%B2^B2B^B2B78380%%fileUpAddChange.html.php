<?php /* Smarty version 2.6.19, created on 2015-05-29 17:53:50
         compiled from fileUpAddChange.html */ ?>
...
.php?id=<?php echo $_REQUEST['id']; ?>
" method="post">
          <p class="center" style="margin-bottom:4px;"><input type="file" name="userFile[]"multiple="multiple" accept="application/pdf" /></p>

          <p class="center" style="margin-bottom:12px;">タイトル : <input type="text" name="imageAlt" value="<?php echo $this->_tpl_vars['upDateImg']['imageAlt']; ?>
" style="width:240px;padding-bottom:4px;" maxlength="10" /></p>
...
<!--- id=<?php echo $this->_tpl_vars['value']['imgId']; ?>
 ...
 --->
                <?php if ($this->_tpl_vars['value']['fileName']): ?>
                    <p style="text-align:center;height:100px;border:none;">
                    <a href="../upImage/<?php echo @FILE_CATEGORY; ?>
...
" target="_blank">ファイルを確認</a>
                ...
                <p class="center" style="padding:0 0 6px 0;overflow:hidden;"><?php if ($this->_tpl_vars['value']['imageAlt']): ?>タイトル : <?php echo $this->_tpl_vars['value']['imageAlt']; ?>
<?php endif; ?></p>
