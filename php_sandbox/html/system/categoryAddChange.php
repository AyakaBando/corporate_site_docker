...
define( 'SQL_TABLE_NAME',   'product_category' );
define( 'PAGE_TITLE',       '製品カテゴリ' );
...
$form->addElement( 'select',       'bigCategoryId',    '大カテゴリ',     $productCategoryArray, array( 'style' => 'max-width:300px;', 'onchange' => "location.href='./categoryAddChange.php?bigCategoryId=' + this.value + '&name=' + document.item.name.value" ) );
