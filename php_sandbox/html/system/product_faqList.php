...
define( 'THE_FILE_NAME',     FILE_CATEGORY . SUB_FILE_CATEGORY . 'List' );
...
$listCount = $query->listCount( SQL_TABLE_NAME, $sqlWhere );
$limit     = 20;
$ls        = 0;
...
$getLink  = createGetLink( array( 'mode', 'faqId', 'disp', 'd', 't', 'r', 'dispFlg', 'disp', 'spotlight' ), $_GET );
$sortLink = createGetLink( array( 'mode', 'faqId', 'disp', 'd', 't', 'r', 'dispFlg', 'disp', 'cond', 'sort', 'spotlight' ), $_GET );
...
if( $_GET['mode'] == 'disp' )
{
    $dispChange = $query->DispChange( SQL_TABLE_NAME, $_GET, array( 'dispFlg' => 'dispFlg', 'title' => 'title', 'id' => 'faqId' ) );
    $title = $query->GetCulumnContents( SQL_TABLE_NAME, 'title', 'faqId', $dispChange, null );
...
if( $_GET['mode'] == 'del' )
{
    $delet = $query->DataDelete( SQL_TABLE_NAME, $_GET, array( 'title' => 'title', 'id' => 'faqId' ) );
