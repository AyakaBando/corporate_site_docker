...
(function ()
{
    var a = function (b, c)
    {
        var d = 1, e = 2, f = 4, g = 8, h = /^\s*(\d+)((px)|\%)?\s*$/i, i = /(^\s*(\d+)((px)|\%)?\s*$)|^$/i, 
        j = /^\d+px$/, k = function ()
        {
        ...
        var p = function (C, D)
        {
            ...
            if (D == 'check')
            {
                ...
                {
                    var F = C.getValueOf('info', 'txtWidth'), G = C.getValueOf('info', 'txtHeight'), H = E.$.width * 1000 / E.$.height, 
                    I = F * 1000 / G;
                    C.lockRatio = false;
                    if (!F && !G) {
                        C.lockRatio = true;
            ...
            if (C.lockRatio) {
                J.removeClass('cke_btn_unlocked');
            }
            else {
                J.addClass('cke_btn_unlocked');
            }
        ...
        w = v('btnLockSizes'), x = v('btnResetSize'), y = v('ImagePreviewLoader'), z = v('ImagePreviewBox'), 
        A = v('previewLink'), B = v('previewImage');
        return {
            title : b.lang.image[c == 'image' ? 'title' : 'titleButton'], minWidth : 420, minHeight : 360, 
            onShow : function ()
            {
                var I = this;
                ...
                I.firstLoad = true;
                I.addLink = false;
                var C = I.getParentEditor(), D = I.getParentEditor().getSelection(), E = D.getSelectedElement(), 
            ...
            contents : [
            {
                id : 'info', label : b.lang.image.infoTab, accessKey : 'I', elements : [
                {
                    type : 'vbox', padding : 0, children : [
                    {
                        ...
                        {
                            id : 'txtUrl', type : 'text', label : b.lang.common.url, required : true, 
                            onChange : function ()
                            {
...

                        {
                            ...
                            align : 'center', label : b.lang.common.browseServer, hidden : true, filebrowser : 'info:txtUrl'
                        }]
                    }]
                },

                {
                    id : 'txtAlt', type : 'text', label : b.lang.image.alt, accessKey : 'T', 'default' : '', 
                    onChange : function ()
                    {
                        l(this.getDialog());
                    },
                    ...
                    {
                        if (C == d) {
                            this.setValue(D.getAttribute('alt'));
                        }
                    },
                    commit : function (C, D)
                    {
                    ...
                    type : 'hbox', children : [
                    {
                        id : 'basic', type : 'vbox', children : [
                        {
                            type : 'hbox', widths : ['50%', '50%'], children : [
                            {
                                ...
                                {
                                    type : 'text', width : '40px', id : 'txtWidth', label : b.lang.common.width, 
                                    onKeyUp : k,
                                    onChange : function ()
                                    {
                                    ...
                                    commit : function (C, D, E)
                                    {
                                        ...
                                        {
                                            if (F) {
                                                D.setStyle('width', CKEDITOR.tools.cssLength(F));
                                            }
                                            else {
                                                D.removeStyle('width');
                                            }
                                        ...
                                        else if (C == f)
                                        {
                                            ...
                                            if (!G)
                                            {
                                                ...
                                                if (H.getCustomData('isReady') == 'true') {
                                                    D.setStyle('width', H.$.width + 'px');
                                                }
                                            }
                                            else {
                                                D.setStyle('width', CKEDITOR.tools.cssLength(F));
                                ...
                                {
                                    type : 'text', id : 'txtHeight', width : '40px', label : b.lang.common.height, 
                                    onKeyUp : k,
                                    onChange : function ()
                                    {
                                        o.call(this, 'advanced:txtdlgGenStyle');
                                    ...
                                    commit : function (C, D, E)
                                    {
                                        ...
                                        {
                                            if (F) {
                                                D.setStyle('height', CKEDITOR.tools.cssLength(F));
                                            }
                                            else {
...

                            {
                                ...
                                onLoad : function ()
                                {
                                    ...
                                    if (D)
                                    {
                                        ...
                                        {
                                            var J = this;
                                            var F = p(J), G = J.originalElement, H = J.getValueOf('info', 
                                            'txtWidth');
...

                        {
                            type : 'vbox', padding : 1, children : [
                            {
                                type : 'text', id : 'txtBorder', width : '60px', label : b.lang.image.border, 
                                'default' : '',
                                onKeyUp : function ()
                                {
                                    l(this.getDialog());
                            ...
                            {
                                type : 'text', id : 'txtHSpace', width : '60px', label : b.lang.image.hSpace, 
                                'default' : '',
                                onKeyUp : function ()
                                {
                                    l(this.getDialog());
                            ...
                            {
                                type : 'text', id : 'txtVSpace', width : '60px', label : b.lang.image.vSpace, 
                                'default' : '',
                                onKeyUp : function ()
                                {
                                    l(this.getDialog());
...

                            {
                                ...
                                label : b.lang.common.align, 'default' : '', items : [[b.lang.common.notSet, 
                                ''], [b.lang.common.alignLeft, 'left'], [b.lang.common.alignRight, 'right']], 
                                onChange : function ()
                                {
                                    l(this.getDialog());
                                    o.call(this, 'advanced:txtdlgGenStyle');
...

            {
                ...
                {
                    id : 'txtUrl', type : 'text', label : b.lang.common.url, style : 'width: 100%', 'default' : '', 
                    setup : function (C, D)
                    {
                        if (C == e) {
                    ...
                    commit : function (C, D)
                    {
                        ...
                        if (C == e) if (F.getValue() || F.isChanged())
                        {
                            ...
                            if (F.getValue() || !b.config.image_removeLinkByEmptyURL) {
                                F.getDialog().addLink = true;
                            }
                        }
                    }
                },
                ...
                {
                    type : 'button', id : 'browse', filebrowser : {
                        action : 'Browse', target : 'Link:txtUrl', url : b.config.filebrowserImageBrowseLinkUrl
                    },
                    style : 'float:right', hidden : true, label : b.lang.common.browseServer
                },

                {
                    id : 'cmbTarget', type : 'select', label : b.lang.common.target, 'default' : '', items : [[b.lang.common.notSet, 
                    ''], [b.lang.common.targetNew, '_blank'], [b.lang.common.targetTop, '_top'], [b.lang.common.targetSelf, 
                    '_self'], [b.lang.common.targetParent, '_parent']],
                    setup : function (C, D)
                    {
                        if (C == e) {
                            this.setValue(D.getAttribute('target') || '');
                        }
                    },
                    commit : function (C, D)
                    {
                        if (C == e) {
                            if (this.getValue() || this.isChanged()) {
                                D.setAttribute('target', this.getValue());
                            };
                        }
                    }
                }]
...

            {
                ...
                elements : [ {
                    type : 'file', id : 'upload', label : b.lang.image.btnUpload, style : 'height:40px', 
                    size : 38
                },


                {
                    type : 'fileButton', id : 'uploadButton', filebrowser : 'info:txtUrl', label : b.lang.image.btnUpload, 
                    'for' : ['Upload', 'upload']
                }]
            },

            {
                id : 'advanced', label : b.lang.common.advancedTab, elements : [
                {
                    ...
                    {
                        type : 'text', id : 'linkId', label : b.lang.common.id,
                        setup : function (C, D)
                        {
                            if (C == d) {
                                this.setValue(D.getAttribute('id'));
                            }
                        },
                        commit : function (C, D)
                        {
                            if (C == d) {
                                if (this.getValue() || this.isChanged()) {
                                    D.setAttribute('id', this.getValue());
                                };
                            }
                        }
                    },
                    ...
                    {
                        id : 'cmbLangDir', type : 'select', style : 'width : 100px;', label : b.lang.common.langDir, 
                        'default' : '', items : [[b.lang.common.notSet, ''], [b.lang.common.langDirLtr, 
                        'ltr'], [b.lang.common.langDirRtl, 'rtl']],
                        setup : function (C, D)
                        {
                            if (C == d) {
                                this.setValue(D.getAttribute('dir'));
                            }
                        },
                        commit : function (C, D)
                        {
                            if (C == d) {
                                if (this.getValue() || this.isChanged()) {
                                    D.setAttribute('dir', this.getValue());
                                };
                            }
                        }
                    },
                    ...
                    {
                        type : 'text', id : 'txtLangCode', label : b.lang.common.langCode, 'default' : '', 
                        setup : function (C, D)
                        {
                            if (C == d) {
                                this.setValue(D.getAttribute('lang'));
                            }
                        },
                        commit : function (C, D)
                        {
                            if (C == d) {
                                if (this.getValue() || this.isChanged()) {
                                    D.setAttribute('lang', this.getValue());
                                };
                            }
                        }
                    }]
                ...
                {
                    type : 'text', id : 'txtGenLongDescr', label : b.lang.common.longDescr, setup : function (C, 
                    D) {
                        if (C == d) {
                            this.setValue(D.getAttribute('longDesc'));
                        }
                    },
                    commit : function (C, D)
                    {
                        ...
                        {
                            if (this.getValue() || this.isChanged()) {
                                D.setAttribute('longDesc', this.getValue());
                            };
                        }
                    }
                },

                {
                    type : 'hbox', widths : ['50%', '50%'], children : [
                    {
                        type : 'text', id : 'txtGenClass', label : b.lang.common.cssClass, 'default' : '', 
                        setup : function (C, D)
                        {
                            if (C == d) {
                        ...
                        commit : function (C, D)
                        {
                            if (C == d) {
                                if (this.getValue() || this.isChanged()) {
                                    D.setAttribute('class', this.getValue());
                                };
                            }
                        }
                    },
                    ...
                    {
                        type : 'text', id : 'txtGenTitle', label : b.lang.common.advisoryTitle, 'default' : '', 
                        onChange : function ()
                        {
                            l(this.getDialog());
                        },
                        ...
                        {
                            if (C == d) {
                                this.setValue(D.getAttribute('title'));
                            }
                        },
                        commit : function (C, D)
                        {
                            ...
                            if (C == d) {
                                if (E.getValue() || E.isChanged()) {
                                    D.setAttribute('title', E.getValue());
                                }
                            }
                            else if (C == f) {
                                D.setAttribute('title', E.getValue());
                ...
                {
                    type : 'text', id : 'txtdlgGenStyle', label : b.lang.common.cssStyle, validate : CKEDITOR.dialog.validate.inlineStyle(b.lang.common.invalidInlineStyle), 
                    'default' : '',
                    setup : function (C, D)
                    {
                        if (C == d)
                        {
                            ...
                            this.setValue(E);
                            var F = D.$.style.height, G = D.$.style.width, H = (F ? F : '').match(h), 
                            I = (G ? G : '').match(h);
                    ...
                    onChange : function ()
                    {
                        o.call(this, ['info:cmbFloat', 'info:cmbAlign', 'info:txtVSpace', 'info:txtHSpace', 
                        'info:txtBorder', 'info:txtWidth', 'info:txtHeight']);
                        l(this);
                    },
                    commit : function (C, D)
                    {
                        if (C == d && (this.getValue() || this.isChanged())) {
                            D.setAttribute('style', this.getValue());
                        }
                    }
                }]
            }]
