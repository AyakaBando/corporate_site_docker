...
<article id="contents" class="privacy">
  ...
  <section class="box">
    <p class="txt02 btm20">この度は、当ホームページをご覧いただき、誠にありがとうございます。<br>アルミ階段、エクステリア製品につきましてご不明な点はございませんか。<br>
ご覧いただいた中で、ご質問やご相談などございましたら、以下のフォームをご活用ください。<br>
必要事項をご入力いただき、【次へ】ボタンをクリック。続いて確認画面に切り替わりますので内容をご確認いただき、<br>間違いがないようでしたら、【完了】ボタンをクリックしてください。</p>
    <p class="txt02 btm20 red02">※お急ぎの方は弊社まで直接お電話もしくはメールにて各詳細内容をご確認下さい。<br>※※※カタログ、資料ご希望の場合は必ず弊社<a href="/catalog/" class="red02">「カタログ請求フォーム」</a>をご利用いただきますようお願い申し上げます。</p>
      ...
      <div class="ta01 btm50">
        <table>
          <tbody>
            ...
            <tr>
              <th>ご質問・お問合せ内容<span class="f10">※</span></th>
              <td>
