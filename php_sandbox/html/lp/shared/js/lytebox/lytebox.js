...
function Lytebox(bInitialize, aHttp) {
	/*** Language Configuration ***/
		...
		this.label['close']		= '閉じる(Esc)';
		this.label['prev'] 		= '前へ';	// Previous (left arrow)
		this.label['next'] 		= '次へ'; 		// Next (right arrow)
		this.label['play'] 		= '再生';
		this.label['pause'] 	= '一時停止';
		this.label['print'] 	= 'Print';
		this.label['image'] 	= 'Image %1 / %2';		// %1 = active image, %2 = total images
		this.label['page'] 		= 'Page %1 / %2'; 		// %1 = active page, %2 = total pages
	...
	/*** Configure Slideshow Options ***/
		...
		this.__slideInterval	= 5000;			// change value (milliseconds) to increase/decrease the time between "slides"
		...
		this.__pauseOnNextClick	= true;		// true to pause the slideshow when the "Next" button is clicked
