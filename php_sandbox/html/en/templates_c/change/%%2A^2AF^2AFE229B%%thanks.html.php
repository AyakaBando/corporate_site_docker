<?php /* Smarty version 2.6.19, created on 2015-08-11 16:16:52
...
<article id="contents">
	<div class="md002">
		<h2 class="head">会員情報変更完了</h2>
	</div>
	<!--/md002-->
	
	<section class="box">
	<p class="txt02 btm40">テキストテキストテキストテキストテキストテキスト<br>
テキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキスト</p>
		...
		<nav class="btn_area">
			...
			<li><a href="" class="btn01">ログインページへ</a></li>
			</ul>
		</nav>
		<!--/btn_area-->
