<?php /* Smarty version 2.6.19, created on 2024-01-10 12:09:17
         compiled from index.html */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'date_format', 'index.html', 88, false),)), $this); ?>
<!DOCTYPE html>
<html>
<head>
	<?php echo '
...
<title>News | Morita Aluminum Industry,inc.</title>
<meta name="description" content="Morita Aluminum Industry,inc.">
<meta name="Keywords" content="">
<meta property="og:title" content="News | Morita Aluminum Industry,inc.">
...
<article id="contents">
	<div class="md002">
		<h2 class="head">News List</h2>
	</div>
	<!--/md002-->
	
	<section class="box">
	<ul id="n_tab">
<li<?php if ($_GET['c'] == 1): ?> class="select"<?php endif; ?>><a href="./?c=1">News</a></li>
<li<?php if ($_GET['c'] == 2): ?> class="select"<?php endif; ?>><a href="./?c=2">Events</a></li>
<li<?php if ($_GET['c'] == 3): ?> class="select"<?php endif; ?>><a href="./?c=3">Product Information</a></li>
<!--<li<?php if ($_GET['c'] == 4): ?> class="select"<?php endif; ?>><a href="./?c=4">採用情報</a></li>-->
</ul>

<nav class="n_box001<?php if (! ($this->_foreach['cresult']['iteration'] <= 1)): ?> disnon<?php endif; ?>">
...
<?php else: ?>./detail.php?id=<?php echo $this->_tpl_vars['value']['id']; ?>
...
<?php endforeach; endif; unset($_from); ?>
	...
	<!--/n_box_in-->
<div class="navi"><?php echo $this->_tpl_vars['pagerLinks']['pages']; ?>
</div>
</nav>
<!--/-->
