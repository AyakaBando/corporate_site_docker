...
<article id="contents">
	<div class="md002">
		<h2 class="head">会員登録</h2>
	</div>
	<!--/md002-->
	
	<section class="box">
	<p class="txt02 btm40">会員になると、図面・カタログ・施工写真のダウンロード、レビューの投稿ができるようになります。<br>
お手数をお掛けいたしますが、下記より、ご登録お願い申し上げます。<br>
また、本サイトでダウンロードいただいた資料、情報につきましては、無断での転載・引用をお断りしております。<br>
あしからずご了承くださいませ。</p>
	</section>
	<!--/box-->
	<section class="box">
...
<?php endif; ?>
		...
		<tr>
			<th scope="row">PDFダウンロードの<br>
きっかけになった媒体を<br>
教えて下さい。</th>
			<td>
<?php echo $this->_tpl_vars['form']['medium']['html']; ?>

								</td>
		</tr>
		<!--<tr>
			<th scope="row">PDF<span class="f10">※</span><br>
<span class="size14">※TAS Glass Step、<br>
TAS Wood Step、<br>
TAS Handrailは<br>
共通のカタログとなっております。</span></th>
			<td>
<?php echo $this->_tpl_vars['form']['pdf']['html']; ?>
