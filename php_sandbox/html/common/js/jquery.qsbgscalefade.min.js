( function( $ ){
    ...
    var $backgrounds = $( "<ul class='sm-slider'></ul>" ),
        ...
        init : function( settings ) {
            ...
            $backgrounds.html(this.mkhtml( options.src )).prependTo("#mv");
        ...
        mkcss: function( bgCount , duration , fade  ) 
        {
            ...
            keyframes = "@keyframes imageAnimation {0% {opacity: 0;animation-timing-function: ease-in;}{0}% {opacity: 1;}{1}% {opacity: 1;}{2}% {opacity: 0; animation-timing-function: ease-out;transform: scale(1.17) translateY(-4%) rotateZ(0deg);}100% { opacity: 0;transform: scale(1.17) translateY(-4%) rotateZ(1deg); }} @keyframes titleAnimation {0% { opacity: 0;transform: translateY(-200px); }{0}% { opacity: 1;transform: translateY(0%); }{1}% { opacity: 1;transform: translateY(0%); }{3}% { opacity: 0; transform: scale(0.4) translateY(100%); }100% { opacity: 0; }}".format(fadeInPercentile,remainPercentile,fadeOutPercentile,fadeOutPercentile_title),
