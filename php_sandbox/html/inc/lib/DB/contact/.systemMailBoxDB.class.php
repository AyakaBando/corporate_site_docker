...
class systemMailBoxDB extends queserserDB
{
    private $tableName = 'contact_mailBox';
    private $tableId   = 'id';
/******************************************************
    # 大カテゴリ
******************************************************/
    ...
    public function DataList( $ls = 0, $limit = 10, $param = array(), $debFlg = null )
    {
        ...
        $queryStr = 
            "SELECT `" . $this->tableId . "`, `name`, `url`, `dispFlg`, `fileName1`, `width1`, `height1`, `priority`, `dateTime` 
               FROM `" . $this->tableName . "` 
