...
******************************************************/
    ...
    public function CategoryDetail( $id = null, $debFlg = null )
    {
        ...
        $queryStr = "SELECT * FROM `en_product_category` WHERE `categoryId` = ? ";
    ...
    public function CategorySortSave( $data = array(), $getParam, $debFlg = null )
    {
        ...
        {
            $queryStr = "UPDATE `en_product_category` SET `priority` = ? WHERE `categoryId` = ? AND `bigCategoryId` = ? LIMIT 1";
