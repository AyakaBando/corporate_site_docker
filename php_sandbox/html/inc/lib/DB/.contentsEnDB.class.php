 ...
 * @stringConnection()
 */
class contentsEnDB extends queserserDB
{
...
**************************************************************************/
    ...
    {
        $queryStr = "SELECT `id`, `fileName`, `width`, `priority` FROM `en_product_img` WHERE `priority` = 1 ";
    ...
    {
        //ユーザー一覧取得
        $queryStr = "SELECT  *  FROM `en_product` WHERE `id` = ? AND `dispFlg` = 1 LIMIT 0, 1";
        ...
        while( $row = $result->fetchRow( DB_FETCHMODE_ASSOC ) )
        {
            /*
            //カタログデータ
            $queryStr = "SELECT `imgId`, `id`, `imageAlt`, `fileName`, `width`, `height`, `dispFlg`, `priority` FROM `en_product_catalog` WHERE `id` = ? AND `dispFlg` = 1 ORDER BY `priority` ";
            ...
            */
            ...
            //メインビジュアルデータ
            $queryStr = "SELECT `id`, `imageAlt`, `fileName`, `width`, `height`, `priority` FROM `en_product_img` WHERE `id` = ? ORDER BY `priority` ";
            ...
            //設置事例データ
            $queryStr = "SELECT `imgId`, `id`, `imageAlt`, `fileName`, `width`, `height`, `dispFlg`, `priority` FROM `en_product_caseImg` WHERE `id` = ? AND `dispFlg` = 1 ORDER BY `priority` ";
            ...
            /*
            //図面データ
            $queryStr = "SELECT `imgId`, `id`, `imageAlt`, `fileName`, `width`, `height`, `dispFlg`, `priority` FROM `en_product_drawing` WHERE `id` = ? AND `dispFlg` = 1 ORDER BY `priority` ";
            ...
            */
            ...
            $queryStr = 
                "SELECT `categoryId`, `id`, `name`, `dispFlg`, `priority` 
                   FROM `en_product_faqcategory` 
                  WHERE `id` = ? AND `dispFlg` = 1 AND ( SELECT COUNT( * ) FROM `product_faq` WHERE `product_faqcategory`.`categoryId` = `product_faq`.`category` AND `product_faq`.`dispFlg` = 1 )
               ORDER BY `priority` ";
            $fcresult = $this->_setQuery( 'query', $queryStr, array( $row['id'] ) );
            while( $fcrow = $fcresult->fetchRow( DB_FETCHMODE_ASSOC ) )
            {
                $row['faq'][$fcrow['priority']]  = $fcrow;
            }
            */
            ...
            */
            ...
            {
                $row['relatedImd'][$key]     = $this->_setQuery( 'getOne', "SELECT `fileName` FROM `en_product_img` WHERE `id` = ? AND `priority` = 1 ", array( $key ) );
                $row['relatedName'][$key]    = $this->_setQuery( 'getOne', "SELECT `name` FROM `en_product` WHERE `id` = ?", array( $key ) );
                $row['relatedSubName'][$key] = $this->_setQuery( 'getOne', "SELECT `subName` FROM `en_product` WHERE `id` = ?", array( $key ) );
            }
...
//print_r( $data );
    ...
    {
        $queryStr = "SELECT `imgId`, `id`, `imageAlt`, `fileName`, `width`, `height`, `dispFlg`, `priority` FROM `en_product_caseImg` WHERE `id` = ? AND `dispFlg` = 1";
        $result = $this->_setQuery( 'query', $queryStr, array( $id ) );
        while( $row = $result->fetchRow( DB_FETCHMODE_ASSOC ) )
        {
...
******************************************************/
    ...
    {
        $queryStr = 
            "INSERT `en_downloadZipCnt` ( `id`, `memberId`, `dateTime` ) VALUES ( ?, ?, ? ) ";
...
******************************************************/
    ...
    public function FaqProductList( $ls = 0, $limit = 10000, $param = array() )
    {
        ...
        $queryStr = 
            "SELECT `id`, `subCategory`, `subName`, `name`, `dateTime`, `dispFlg` " . $sqlSelect . " 
               FROM `en_product` 
              WHERE `dispFlg` = 1 AND ( SELECT COUNT( * ) FROM `en_product_faq` WHERE `en_product_faq`.`id` = `product`.`id` AND `en_product_faq`.`dispFlg` = 1 ) >= 1 
...
//$debFlg++;
    ...
    public function NewsDetail( $id )
    {
        $queryStr = 
            "SELECT * 
               FROM `en_whatsNew` WHERE `dispFlg` = ? AND `id` = ? LIMIT 0, 1";
...
******************************************************/
    ...
    {
        $queryStr = "SELECT `imgId`, `imageAlt`, `fileName`, `width`, `height`, `dispFlg`, `priority` FROM `en_topMainVisual` WHERE `dispFlg` = 1 ORDER BY `priority` ";
        $result = $this->_setQuery( 'query', $queryStr, array() );
        while( $row = $result->fetchRow( DB_FETCHMODE_ASSOC ) )
            $data[]  = $row;
