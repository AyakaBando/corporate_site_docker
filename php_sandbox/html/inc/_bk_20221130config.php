...
function contactCatalogArray( $emptyFlg = null )
{
    if( $emptyFlg )$returnArray[0]  = '';
    $returnArray[1]   = 'アルミ手摺';
    $returnArray[2]   = 'Flange Port、<br>他エクステリア';
    $returnArray[3]   = 'ステアーズ';
    $returnArray[4]   = 'エアリー';
...
function memberRegDowmArray( $emptyFlg = null )
{
    ...
    $returnArray[3]  = 'SNS(Twitter、Facebook）';
