...
// +----------------------------------------------------------------------+
//
// $Id: RLTB.php,v 1.1.1.1 2004/04/19 23:47:14 ieure Exp $
 ...
 * @since 1.0
 */
class HTML_Table_Matrix_Filler_RLTB extends HTML_Table_Matrix_Filler {
    /**
     * Constructor
     *
     ...
     * @return void
     */
    function HTML_Table_Matrix_Filler_RLTB(&$matrix, $options = false) {
    ...
    function next($index) {
        if ($index == 0) {
            ...
            $this->col--;
            if ($this->col < $this->matrix->_fillStartCol) {
                $this->col = $this->matrix->_cols - 1;
                $this->row++;
            }
        }
