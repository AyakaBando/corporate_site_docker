...
*/
    'required'      => array('html_quickform_rule_required', dirname(__FILE__) . '/QuickForm/Rule/Required.php'),
    'maxlength'     => array('html_quickform_rule_range',    dirname(__FILE__) . '/QuickForm/Rule/Range.php'),
    'minlength'     => array('html_quickform_rule_range',    dirname(__FILE__) . '/QuickForm/Rule/Range.php'),
    'rangelength'   => array('html_quickform_rule_range',    dirname(__FILE__) . '/QuickForm/Rule/Range.php'),
    'email'         => array('html_quickform_rule_email',    dirname(__FILE__) . '/QuickForm/Rule/Email.php'),
    'regex'         => array('html_quickform_rule_regex',    dirname(__FILE__) . '/QuickForm/Rule/Regex.php'),
    'lettersonly'   => array('html_quickform_rule_regex',    dirname(__FILE__) . '/QuickForm/Rule/Regex.php'),
    'alphanumeric'  => array('html_quickform_rule_regex',    dirname(__FILE__) . '/QuickForm/Rule/Regex.php'),
    'numeric'       => array('html_quickform_rule_regex',    dirname(__FILE__) . '/QuickForm/Rule/Regex.php'),
    'nopunctuation' => array('html_quickform_rule_regex',    dirname(__FILE__) . '/QuickForm/Rule/Regex.php'),
    'nonzero'       => array('html_quickform_rule_regex',    dirname(__FILE__) . '/QuickForm/Rule/Regex.php'),
    'callback'      => array('html_quickform_rule_callback', dirname(__FILE__) . '/QuickForm/Rule/Callback.php'),
    'compare'       => array('html_quickform_rule_compare',  dirname(__FILE__) . '/QuickForm/Rule/Compare.php')
);
